...
export const BlogView = ({ markdownContent }: { markdownContent: string }) => {
  ...
  return (
    <div className={`relative min-h-screen w-full overflow-x-hidden bg-[#0A0A0A] text-white selection:bg-[#F59E0B]/30 ${inter.className}`}>
      {/* Background glow effects - Styled with Amber/Orange for Blog */}
      <div className="pointer-events-none absolute left-0 top-0 -z-10 h-full w-full overflow-hidden">
        <div className="absolute -top-[20%] -left-[10%] h-[500px] w-[500px] rounded-full bg-[#F59E0B]/10 blur-[120px]" />
        <div className="absolute top-[20%] -right-[10%] h-[600px] w-[600px] rounded-full bg-[#00E676]/5 blur-[150px]" />
        <div className="absolute bottom-0 left-[20%] h-[400px] w-[600px] rounded-full bg-orange-600/10 blur-[150px]" />
      </div>
      ...
      <main className="relative z-10 flex flex-col items-center pt-24 pb-20">
        <article className="w-full max-w-4xl px-6 md:px-8">
          ...
          <div className="prose prose-invert prose-lg max-w-none 
            ...
            prose-h1:text-4xl md:prose-h1:text-6xl prose-h1:mb-8 prose-h1:bg-clip-text prose-h1:text-transparent prose-h1:bg-gradient-to-r prose-h1:from-white prose-h1:to-[#F59E0B]
            ...
            prose-h3:text-xl md:prose-h3:text-2xl prose-h3:mt-8 prose-h3:mb-4 prose-h3:text-[#F59E0B]
            prose-p:text-white/70 prose-p:leading-relaxed 
            prose-a:text-[#F59E0B] prose-a:no-underline hover:prose-a:underline prose-a:transition-all

      ...
      <main className="relative z-10 flex flex-col items-center pt-24 pb-20">
        <article className="w-full max-w-4xl px-6 md:px-8">
          ...
          <div className="prose prose-invert prose-lg max-w-none 
            ...
            prose-h1:text-4xl md:prose-h1:text-6xl prose-h1:mb-8 prose-h1:bg-clip-text prose-h1:text-transparent prose-h1:bg-gradient-to-r prose-h1:from-white prose-h1:to-[#06B6D4]
            ...
            prose-h3:text-xl md:prose-h3:text-2xl prose-h3:mt-8 prose-h3:mb-4 prose-h3:text-[#06B6D4]
            prose-p:text-white/70 prose-p:leading-relaxed 
            prose-a:text-[#06B6D4] prose-a:no-underline hover:prose-a:underline prose-a:transition-all
            ...
            prose-blockquote:border-l-4 prose-blockquote:border-[#06B6D4] prose-blockquote:bg-gradient-to-r prose-blockquote:from-[#06B6D4]/10 prose-blockquote:to-transparent prose-blockquote:not-italic prose-blockquote:py-6 prose-blockquote:px-8 prose-blockquote:rounded-r-xl prose-blockquote:text-white/90 prose-blockquote:shadow-sm
            ...
            <ReactMarkdown 
              ...
              components={{
                code(props) {
                  ...
                  return (
                    <code {...rest} className={className ? `${className} bg-[#06B6D4]/10 text-white px-1.5 py-0.5 rounded-md text-sm font-mono border border-[#06B6D4]/20` : 'bg-[#06B6D4]/10 text-white px-1.5 py-0.5 rounded-md text-sm font-mono border border-[#06B6D4]/20'}>
                      {children}
                    </code>
                  );
                }
